...
version = "0.2.8-1"               -- TODO: renumber, must match the info in the filename of this rockspec!
-- The version '0.2.8' is the source code version, the trailing '1' is the version of this rockspec.
...
build = {
  ...
  modules = {
    ...
    ["kong.plugins.moesif.utf8_validator"] = "kong/plugins/moesif/utf8_validator.lua"
  }
}
